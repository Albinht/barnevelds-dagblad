...
export default function SportGrid({ articles }: SportGridProps) {
    ...
    <section className="mb-12">
      ...
      {gridArticles.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 h-auto md:h-[350px] mb-6">
          {/* Main Article - spans 2 columns horizontally */}
          {gridArticles[0] && (
            <Link
            ...
            >
              ...
              {/* Sport Badge */}
              <div className="absolute top-4 left-4 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded uppercase">
                LIVE SPORT
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <div className="text-xs text-white/80 uppercase font-semibold mb-2">
                  {gridArticles[0].category} • VOETBAL
                </div>
          ...
          {gridArticles[3] && (
            ...
            >
              ...
              {/* Sport Type Badge */}
              <div className="absolute bottom-8 left-2 bg-orange-600 text-white text-xs font-bold px-2 py-1 rounded uppercase">
                TENNIS
              </div>
          ...
          {listArticles.slice(0, 3).map((article) => (
            ...
            >
              <div className="w-24 h-16 md:w-40 md:h-24 flex-shrink-0 relative overflow-hidden rounded">
                ...
                {/* Sport Badge */}
                <div className="absolute top-1 right-1 bg-red-600 text-white text-xs font-bold px-1 py-0.5 rounded uppercase">
                  SPORT
                </div>
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-xs md:text-sm text-red-600 font-semibold mb-1 md:mb-2 uppercase">
                  SPORT • {article.publishedAt}
                </div>
