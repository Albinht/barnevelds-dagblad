...
export default function GoogleLoginForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Use direct redirect instead of manual session checking
      await signIn('google', {
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-6 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-r-md">
            <div className="text-center">
              <p className="text-sm font-medium text-blue-800 mb-2">🔐 Authorized Access Only</p>
              <p className="text-sm text-blue-700">
                Only authorized Google accounts can access the editorial dashboard.
